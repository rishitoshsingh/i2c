...
#SBATCH --job-name=i2c-dino-bert-8k
#SBATCH --mem=16G
#SBATCH --mail-type=ALL # Send an e-mail when a job starts, stops, or fails
#SBATCH --mail-user=rksing18@asu.edu
#SBATCH --output=/home/rksing18/i2c/runs/bert/8k/output_multi.out
#SBATCH --error=/home/rksing18/i2c/runs/bert/8k/error_multi.err
